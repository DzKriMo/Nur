                    ...
                    {tabs.map(({ id, label, icon: Icon }) => (
                        ...
                        >
                            ...
                            <span className={`text-xs px-1.5 rounded-full ${
                                tab === id ? 'bg-white/20' : 'bg-slate-100 dark:bg-slate-800'
                            }`}>
                    ...
                    quranBookmarks.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {quranBookmarks.map((b) => (
                                <div key={`${b.surahId}-${b.verseNum}`} className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-100 dark:border-slate-800">
                    ...
                    hadithFavorites.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {hadithFavorites.map((f) => (
                                <div key={`${f.bookId}-${f.hadithId}`} className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-100 dark:border-slate-800">
                                    <div className="flex justify-between items-center mb-3">
                                        <Link
