...
import { Book, BookOpenText, Heart, MessageCircle, Info, Home, Moon, Sun, Menu, X, Clock, Scroll, GraduationCap, Star } from 'lucide-react';
...
export default function Navbar() {
    ...
    const links = [
        ...
        { href: '/names', label: t('nav.names'), icon: Star },
