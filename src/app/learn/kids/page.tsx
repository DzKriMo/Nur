                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden">
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className={`text-slate-600 dark:text-slate-300 leading-relaxed text-lg font-arabic whitespace-pre-line ${isAr ? 'text-right' : ''}`}>
                                {stepContent}
                            </div>
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pt-20 md:pt-24 px-4 pb-16">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    {completedCount > 0 && (
                        <div className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-full bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-sm text-amber-700 dark:text-amber-300">
                            <Star size={15} className="fill-amber-400 text-amber-400" />
                            {completedCount} / {kidsLessons.length} {t('learn.lessons_completed')}
                        </div>
                    )}
                </div>
