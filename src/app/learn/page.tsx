                    ...
                    {modes.map((mode) => {
                        ...
                        return (
                            <Link
                                key={mode.href}
                                href={mode.href}
                                className={`bg-white dark:bg-night-900 p-8 rounded-2xl border ${colors.border} shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center`}
                            >
