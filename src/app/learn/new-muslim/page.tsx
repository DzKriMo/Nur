                    ...
                    {newConvertLessons.map((lesson) => {
                        ...
                        return (
                            <button
                                ...
                                className="bg-white dark:bg-night-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-lg hover:border-emerald-200 dark:hover:border-emerald-800 transition-all duration-300 text-left relative"
                            >
                                {done && (
